...
public class Fase1Facil extends JPanel implements ActionListener, Fase {
   private Image fundo;
   ...
   private class TecladoAdapter extends KeyAdapter {
      ...
      public void keyPressed(KeyEvent arg0) {
         if (arg0.getKeyCode() == 10) {
            Fase1Facil.this.emJogo = true;
            Fase1Facil.this.eu = new PersonagemFacil();
            Fase1Facil.this.inicializaInimigos();
            Fase1Facil.this.isboss = true;
            Fase1Facil.this.bossHit = 49;
         }

         Fase1Facil.this.eu.keyPressed(arg0);
      }

      public void keyReleased(KeyEvent arg0) {
         Fase1Facil.this.eu.keyReleased(arg0);
      }
