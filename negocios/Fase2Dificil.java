...
public class Fase2Dificil extends JPanel implements ActionListener, Fase {
   private Image fundo;
   ...
   private class TecladoAdapter extends KeyAdapter {
      ...
      public void keyPressed(KeyEvent arg0) {
         if (arg0.getKeyCode() == 10) {
            Fase2Dificil.this.emJogo = true;
            Fase2Dificil.this.eu = new PersonagemDificil();
            Fase2Dificil.this.inicializaInimigos();
            Fase2Dificil.this.isboss = true;
            Fase2Dificil.this.bossHit = 49;
         }

         Fase2Dificil.this.eu.keyPressed(arg0);
      }

      public void keyReleased(KeyEvent arg0) {
         Fase2Dificil.this.eu.keyReleased(arg0);
      }
